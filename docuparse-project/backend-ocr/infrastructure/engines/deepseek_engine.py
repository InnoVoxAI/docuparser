# =============================================================================
# INFRASTRUCTURE: infrastructure/engines/deepseek_engine.py
# =============================================================================
# Engine OCR via modelo Deepseek multimodal (Ollama local).
#
# Origem: migrado de engines/deepseek_engine.py (Fase 4 do refactor).
# engines/deepseek_engine.py agora é shim que re-exporta desta localização.
#
...
class DeepSeekEngine(BaseOCREngine):
    ...
    def process(self, content: Any, metadata: dict[str, Any] | None = None) -> Dict[str, Any]:
        ...
        if isinstance(content, dict):
            source = content.get("preprocessed") or content.get("original")
