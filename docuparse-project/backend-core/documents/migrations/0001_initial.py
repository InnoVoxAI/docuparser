...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="document",
            index=models.Index(
                fields=["tenant", "status"], name="documents_d_tenant__718ecf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="document",
            index=models.Index(
                fields=["tenant", "received_at"], name="documents_d_tenant__5cdd99_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="documentevent",
            index=models.Index(
                fields=["tenant", "event_type"], name="documents_d_tenant__2b6fe7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="documentevent",
            index=models.Index(
                ...
                name="documents_d_documen_10c14b_idx",
            ),
        ),
