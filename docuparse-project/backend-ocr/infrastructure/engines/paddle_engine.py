# =============================================================================
# INFRASTRUCTURE: infrastructure/engines/paddle_engine.py
# =============================================================================
# Engine OCR via PaddleOCR — melhor performance para documentos escaneados.
#
# Origem: migrado de engines/paddle_engine.py (Fase 4 do refactor).
# engines/paddle_engine.py agora é shim que re-exporta desta localização.
#
...
class PaddleOCREngine(BaseOCREngine):
    ...
    def process(self, content: Any, metadata: dict[str, Any] | None = None) -> Dict[str, Any]:
        ...
        if isinstance(content, dict):
            source_for_ocr = content.get("preprocessed") or content.get("original")
