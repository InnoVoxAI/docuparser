...
urlpatterns = [
    ...
    path("documents/<uuid:document_id>/langextract", document_langextract_view, name="document-langextract"),
    path("documents/<uuid:document_id>/fields", document_save_fields_view, name="document-save-fields"),
    path("documents/<uuid:document_id>/field-versions", document_field_versions_view, name="document-field-versions"),
