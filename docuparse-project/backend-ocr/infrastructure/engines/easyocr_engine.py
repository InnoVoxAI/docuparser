# =============================================================================
# INFRASTRUCTURE: infrastructure/engines/easyocr_engine.py
# =============================================================================
# Engine OCR via EasyOCR.
#
# Origem: migrado de engines/easyocr_engine.py (Fase 4 do refactor).
# engines/easyocr_engine.py agora é shim que re-exporta desta localização.
#
