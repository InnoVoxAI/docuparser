# =============================================================================
# INFRASTRUCTURE: infrastructure/engines/trocr_engine.py
# =============================================================================
# Engine OCR transformer para manuscritos (Microsoft TrOCR).
#
# Origem: migrado de engines/trocr_engine.py (Fase 4 do refactor).
# engines/trocr_engine.py agora é shim que re-exporta desta localização.
#
