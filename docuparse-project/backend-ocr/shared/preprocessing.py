# =============================================================================
# SHARED: shared/preprocessing.py
# =============================================================================
# Pipelines de pré-processamento de imagem reutilizáveis por qualquer camada.
#
# Origem: movido de utils/preprocessing.py (Fase 2 do refactor).
# O arquivo utils/preprocessing.py foi convertido em shim de backward-compat.
#
# O que há aqui:
#   - Operações de baixo nível (decode, encode, deskew, CLAHE, denoise, sharpen)
#   - Pipelines específicos por engine (paddle, easyocr, trocr, deepseek, etc.)
#   - Segmentação de regiões de documento (handwritten, printed, signature)
#
