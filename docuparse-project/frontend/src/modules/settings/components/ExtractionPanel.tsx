...
/**
 * Container da área "Extração" (builder LangExtract) — orquestra
 * `useExtractionState` (estado/efeitos/handlers) e delega cada aba de
 * `SETTINGS_TABS` a um componente apresentacional dedicado, mesmo padrão de
 * `ValidationView` (T030): container fino + hook de estado + componentes.
 */
